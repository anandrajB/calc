        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '20px' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '30px', alignItems: 'center', minHeight: 'calc(100vh - 40px)' }}>
            ...
            <div style={{ flex: '1', minWidth: '280px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: 'clamp(14px, 2vw, 16px)', marginBottom: '20px' }}>
            ...
            <div style={{ flex: '1.2', minWidth: '300px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <div style={{
                ...
                <img
                  src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'%3E%3Crect fill='%23f0f9ff' width='400' height='300'/%3E%3Cg fill='%23667eea'%3E%3Ccircle cx='200' cy='80' r='35'/%3E%3Cpath d='M200 115 L190 135 L210 135 Z'/%3E%3Crect x='165' y='135' width='70' height='80' rx='5'/%3E%3Crect x='145' y='215' width='110' height='15' rx='3'/%3E%3Cpath d='M80 230 L320 230' stroke='%2394a3b8' stroke-width='2'/%3E%3C/g%3E%3Ctext x='200' y='270' text-anchor='middle' fill='%23667eea' font-size='16' font-weight='600'%3ESolar Panel System%3C/text%3E%3C/svg%3E"
                  alt="Solar Panel System"
                  style={{ width: '100%', height: 'auto', borderRadius: '12px' }}
                />
                <div style={{ marginTop: '20px', textAlign: 'center' }}>
                  <h3 style={{ color: '#667eea', fontSize: '20px', fontWeight: '600', marginBottom: '8px' }}>
                    Clean Energy Solution
                  </h3>
                  <p style={{ color: '#64748b', fontSize: '14px' }}>
                    Reduce your carbon footprint and save on electricity bills with solar power
                  </p>
                </div>
              </div>
            </div>
